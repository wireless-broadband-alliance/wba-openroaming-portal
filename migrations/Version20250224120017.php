...
final class Version20250224120017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE User ADD twoFAsecret VARCHAR(255) DEFAULT NULL, ADD twoFAtype VARCHAR(255) DEFAULT UserTwoFactorAuthenticationStatus::DISABLED->value, ADD twoFAcode VARCHAR(10) DEFAULT NULL, ADD twoFAcodeGeneratedAt DATETIME DEFAULT NULL');
    }
