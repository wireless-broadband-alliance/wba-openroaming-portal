...
class SettingFixture extends Fixture
{
    public function load(ObjectManager $manager)
    {
        $settings = [
            ...
            ['name' => 'REGISTER_METHOD_ENABLED', 'value' => 'false'],
            ['name' => 'REGISTER_METHOD_LABEL', 'value' => 'Create Account'],
            ['name' => 'REGISTER_METHOD_DESCRIPTION', 'value' => 'Don\'t have an account? Create one'],
