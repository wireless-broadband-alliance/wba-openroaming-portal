...
class AuthController extends AbstractController
{
    ...
    public function authLocalMagic(Request $request): JsonResponse
    {
        ...
        // Generate JWT Token
        /* TODO Change this part of the code to have the logic to send the emails / phoneNumber messages with the links */

        // Prepare response data
        /* Send the confirmation message after when the endpoint response is completed */
