    ...
    public function getSettingDescription($settingName): ?string
    {
        ...
        $descriptions = [
            LanguagesType::EN->value => [
                ...
                'LOGIN_WITH_UUID_ONLY' => 'Defines whether authentication is performed using a confirmation code sent to the user or a tradicional uuid & password. This feature when is set to "OFF" will send a reset password email for all the users portal accounts.',
                ...
                'VALID_DOMAINS_GOOGLE_LOGIN' => 'When this is empty, it allows all the domains to authenticate. Please only type the domains you want to be able to authenticate. Domains must be separated by ","',
                'VALID_DOMAINS_MICROSOFT_LOGIN' => 'When this is empty, it allows all the domains to authenticate. Please only type the domains you want to be able to authenticate. Domains must be separated by ","',
            ...
            LanguagesType::PT->value => [
                ...
                'LOGIN_WITH_UUID_ONLY' => 'Define se a autenticação é feita usando um código de confirmação enviado ao utilizador ou a tradicional uuid e password. Esta funcionalidade, quando definida como "OFF", irá enviar um e-mail de reset de palavra-passe para todas os utilizadores com conta no portal.',
                ...
                'VALID_DOMAINS_GOOGLE_LOGIN' => 'Quando vazio, permite que todos os domínios se autentiquem. Introduza apenas os domínios que pretende permitir. Os dominios devem ser separados por ","',
                'VALID_DOMAINS_MICROSOFT_LOGIN' => 'Quando vazio, permite que todos os domínios se autentiquem. Introduza apenas os domínios que pretende permitir. Os dominios devem ser separados por ","',
