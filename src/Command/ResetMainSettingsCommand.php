...
<info>Success:</info> The main settings have been updated.
<comment>Note:</comment> If you want to reset the custom settings too,
       make sure to run the following command:
       <fg=blue>php bin/console something:here</>
EOL;
// change the command here later after finish the reset of the main settings
