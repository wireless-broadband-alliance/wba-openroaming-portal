...
final class TogglePasswordTypeExtension extends AbstractTypeExtension
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setNormalizer(
            ...
            static fn (Options $options, $labelTranslationDomain) =>
                $labelTranslationDomain ?? $options['translation_domain'],
        );
    ...
    public function buildView(FormView $view, FormInterface $form, array $options): void
    {
        ...
        if (false !== $options['toggle_translation_domain']) {
            $controllerValues['hidden-label'] = $this->translateLabel(
                ...
                $options['toggle_translation_domain']
            );
    ...
    {
        if (!$this->translator instanceof \Symfony\Contracts\Translation\TranslatorInterface || null === $label) {
            return $label;
        }
