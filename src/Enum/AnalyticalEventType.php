...
enum AnalyticalEventType: string
{
    ...
    case ADMIN_DISABLED_SAML_PROVIDER = 'ADMIN_DISABLED_SAML_PROVIDER';
    case ADMIN_ADDED_SAML_PROVIDER = 'ADMIN_ADDED_SAML_PROVIDER';
    case ADMIN_EDITED_SAML_PROVIDER = 'ADMIN_EDITED_SAML_PROVIDER';
    case ADMIN_EDITED_SAML_PROVIDER_EXTRA_OPTIONS = 'ADMIN_EDITED_SAML_PROVIDER_EXTRA_OPTIONS';
    ...
    case ENABLE_APP_2FA = 'ENABLE_APP_2FA';
    case VERIFY_APP_2FA = 'VERIFY_APP_2FA';
