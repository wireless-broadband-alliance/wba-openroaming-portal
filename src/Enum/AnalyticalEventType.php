...
enum AnalyticalEventType: string
{
    ...
    case LOGIN_TRADITIONAL_REQUEST_RESEND_CODE = 'LOGIN_TRADITIONAL_REQUEST_RESEND_CODE';
    ...
    case USER_PASSWORD_RESET_FROM_SETTING_AUTH = 'USER_PASSWORD_RESET_FROM_SETTING_AUTH';
