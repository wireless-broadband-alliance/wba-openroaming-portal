...
enum AnalyticalEventType: string
{
    ...
    public const DELETED_SAML_PROVIDER_BY = 'DELETED_SAML_PROVIDER_BY';
    public const REVOKED_SAML_PROVIDER_BY  = 'REVOKED_SAML_PROVIDER_BY';
    ...
    public const ADMIN_ENABLED_SAML_PROVIDER = 'ADMIN_ENABLED_SAML_PROVIDER';
    public const ADMIN_ADDED_SAML_PROVIDER = 'ADMIN_ADDED_SAML_PROVIDER';
    public const ADMIN_EDITED_SAML_PROVIDER = 'ADMIN_EDITED_SAML_PROVIDER';
    public const CONFIG_PROFILE_ANDROID = 'CONFIG_PROFILE_ANDROID';
    public const CONFIG_PROFILE_IOS = 'CONFIG_PROFILE_IOS';
}
