...
56. `PROFILE_LIMIT_DATE_EMAIL`: Time in days to disable profiles for users with EMAIL login
57. `PROFILE_LIMIT_DATE_SMS`: Time in days to disable profiles for users with SMS login
